    ...
    Subscription.aggregate([
      ...
      { $unwind: "$days" },
      {
        $group: {
          ...
          vechicle_catgory: { $addToSet: "$get_vehicle.vechicle_catgory" },
          //   msid:{ $sum: 1},
        },
      },
      {
        $project: {
          days: "$days",
          vechicle_catgory: "$vechicle_catgory",
          vendor: "$vendor",
      ...
      {
        $addFields: {
          convertedId9: { $toObjectId: "$vechicle_catgory" },
        },
      },
      {
        $lookup: {
      ...
      },
      {
        $project: {
          ...
          vehicle_category: "$get_vehicle_cat.cat_name",
          vendor: "$vendor",
          status: "$status",
        },
      },
